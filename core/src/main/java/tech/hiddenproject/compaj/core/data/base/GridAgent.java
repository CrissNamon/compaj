...
public class GridAgent implements Agent<GridLocation, String> {
  ...
  private BiFunction<Agent<GridLocation, String>, Agent<GridLocation, String>, Boolean>
      connectFunction;
  ...
  public GridAgent(String group) {
    ...
    moveAs(
        (i, a) -> {
          double x =
              getLocation().getX() + ((Math.random() - 0.5) * 20) * Math.cos(Math.random() * 360);
          double y =
              getLocation().getY() + ((Math.random() - 0.5) * 20) * Math.sin(Math.random() * 360);
  ...
  @Override
  public void connectsIf(
      BiFunction<Agent<GridLocation, String>, Agent<GridLocation, String>, Boolean> function) {
    connectFunction = function;
  }

  @Override
  public void interactsAs(
      BiConsumer<Agent<GridLocation, String>, Agent<GridLocation, String>> function) {
  ...
  @Override
  public void collidesAs(
      BiFunction<EnvironmentObject<GridLocation>, GridLocation, GridLocation> function) {
  ...
  public String toString() {
    return "GridAgent{" + "id=" + id + ", location=" + location + ", group='" + group + '\'' + '}';
  }
}
