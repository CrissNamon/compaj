...
public class LineChartBuilder {
  ...
  public LineChartBuilder with(String name, List<? extends Number> xData, List<? extends Number> yData) {
    ...
    for (int i = 0; i < xData.size(); ++ i) {
      dataSeries.getData().add(
          new XYChart.Data<>(xData.get(i).doubleValue(), yData.get(i).doubleValue())
      );
    }
